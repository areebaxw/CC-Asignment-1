...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_NUMBER = 10,                  /* T_NUMBER  */
  YYSYMBOL_T_BOOL = 11,                    /* T_BOOL  */
  YYSYMBOL_T_NULL = 12,                    /* T_NULL  */
...
{
       0,    48,    48,    52,    53,    54,    55,    56,    57,    61,
      62,    66,    71,    79,    86,    87,    91,    95
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LBRACKET", "RBRACKET", "COLON", "COMMA", "T_STRING", "T_NUMBER",
  "T_BOOL", "T_NULL", "$accept", "input", "value", "object", "members",
  "member", "array", "elements", YY_NULLPTR
};
...
{
      13,    -3,    -1,    -4,    -4,    -4,    -4,     3,    -4,    -4,
      -4,    -4,     0,    11,    -4,    -4,    -4,     6,    -4,    13,
      -4,     4,    -4,    13,    -4,    -4,    -4
};
...
{
      16,    11,     1,    18,     2,    15,    12,    19,     3,     4,
       5,     6,    22,    12,    23,    20,     1,    24,     2,    21,
       0,    26,     3,     4,     5,     6,    25
};
...
{
       0,     3,     5,     9,    10,    11,    12,    14,    15,    16,
      19,     4,     9,    17,    18,     6,    15,    20,     0,     7,
       4,     8,     6,     8,    15,    18,    15
};
...
#line 1116 "parser.tab.c"
  ...
  case 5: /* value: T_STRING  */
#line 54 "parser.y"
                 { (yyval.node) = new StringNode(*(yyvsp[0].sval)); delete (yyvsp[0].sval); }
#line 1122 "parser.tab.c"
    break;

  case 6: /* value: T_NUMBER  */
#line 55 "parser.y"
                 { (yyval.node) = new NumberNode(*(yyvsp[0].sval)); delete (yyvsp[0].sval); }
...
#line 61 "parser.y"
                  { (yyval.node) = new ObjectNode(); }
#line 1146 "parser.tab.c"
    break;

  case 10: /* object: LBRACE members RBRACE  */
#line 62 "parser.y"
...
#line 66 "parser.y"
           { 
        (yyval.node) = new ObjectNode();
        ((ObjectNode*)(yyval.node))->addMember((yyvsp[0].member)->first, (yyvsp[0].member)->second);
        delete (yyvsp[0].member);
    }
#line 1162 "parser.tab.c"
    break;

  case 12: /* members: members COMMA member  */
#line 71 "parser.y"
                           {
...
#line 1172 "parser.tab.c"
  ...
  case 13: /* member: T_STRING COLON value  */
#line 79 "parser.y"
                         {
        (yyval.member) = new pair<string, ASTNode*>(*(yyvsp[-2].sval), (yyvsp[0].node));
        delete (yyvsp[-2].sval);
    }
...
#line 91 "parser.y"
          {
        (yyval.node) = new ArrayNode();
        ((ArrayNode*)(yyval.node))->addElement((yyvsp[0].node));
    }
